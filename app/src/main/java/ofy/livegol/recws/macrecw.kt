...
class macrecw(val maclar: ArrayList<macdata>, val Conte: Context,val Canlimi:Boolean) : androidx.recyclerview.widget.RecyclerView.Adapter<macrecw.macviewholder>() {
    ...
    inner class macviewholder(val Viev: View, var ViewGroup: ViewGroup) : androidx.recyclerview.widget.RecyclerView.ViewHolder(Viev) {
        ...
        val macsaatyaz = teksatirmac.textView_macsaati
