...
class CanliFree(val kuponlar: ArrayList<Canlidata>, val Contex: Context) : androidx.recyclerview.widget.RecyclerView.Adapter<CanliFree.Kasaviewholder>() {
    ...
    inner class Kasaviewholder(val Viev: View, var ViewGroup: ViewGroup) : androidx.recyclerview.widget.RecyclerView.ViewHolder(Viev) {
        ...
        fun atama(position: Int) {
            ...
            val adpt = macrecwf(kuponlar[position].maclar!!, Contex, macdurumu)
